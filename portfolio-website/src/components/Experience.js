    ...
    <section id="experience" className="experience-container">
      <div className="experience-content">
        ...
        <div className="experience-grid">
          <div className="card">
          <h3>
                <a href="https://www.midocean.tech" target="_blank" rel="noopener noreferrer">
                  Midocean Technologies
                </a>
              </h3>
            <h4>Software Engineer (Jan 2022 – May 2022)</h4>
          ...
          <div className="card">
          <h3>
                <a href="https://www.midoceantecn.tech" target="_blank" rel="noopener noreferrer">
                  Midocean Technologies
                </a>
              </h3>
